    ...
    <div className="mo-page">
      ...
      <div className="mo-overlay" role="presentation">
        <div className="mo-modal" role="dialog" aria-modal="true" aria-label="Set new monthly objective">
          <button className="mo-close" onClick={() => navigate(-1)} aria-label="Close">
          ...
          <button className="mo-primary" onClick={() => navigate(-1)}>
            SET OBJECTIVE
          </button>
          <button className="mo-secondary" onClick={() => navigate(-1)}>
            CANCEL &amp; RETURN
          </button>
        </div>
      </div>
